...
io.write('\27[1;31m ↓ ارسل يوزر المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOUSERNAME = io.read():gsub('@','')
if SUDOUSERNAME ~= '' then
io.write('\n\27[1;34m تم حفظ يوزر المطور :\n\27[0;39;49m')
database:set(id_server..":SUDO:USERNAME",'@'..SUDOUSERNAME)
else
print('\n\27[1;34m لم يتم حفظ يوزر المطور :')
end 
os.execute('lua SHELBY.lua')
end
...
print('\n\27[1;34m Welcome to the all-new and powerful Source SHELBY ')
file = io.open("SHELBY", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/SHELBY
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SHELBY.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SHELBY -X kill
screen -S SHELBY ./SHELBY
done
]])  
file:close() 
...
if hash or SudoBot(msg) or DevSHELBYW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSHELBYW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSHELBYW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSHELBYW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSHELBYW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSHELBYW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSHELBYW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1465643981) then
var = true  
...
local UserName = (data.username_ or "SSS_Hl")
...
local SHELBY_Msg = ''  
if msgs < 100 then 
SHELBY_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SHELBY_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SHELBY_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SHELBY_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SHELBY_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SHELBY_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SHELBY_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SHELBY_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SHELBY_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SHELBY_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SHELBY_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SHELBY_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SHELBY_Msg = 'رب التفاعل'  
end 
return SHELBY_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSHELBY(msg,data) -- بداية العمل
if msg then
...
SourceSHELBYr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الكروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/SSS_Hl)'
end 
send(msg.chat_id_, msg.id_, SourceSHELBYr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevSHELBYW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevSHELBYW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,SHELBY_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevSHELBYW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevSHELBYW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevSHELBYW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevSHELBYW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevSHELBYW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevSHELBYW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevSHELBYW(msg) then 
...
if text == 'تحديث السورس ❃' and DevSHELBYW(msg) then 
os.execute('rm -rf SHELBY.lua')
os.execute('wget https://raw.githubusercontent.com/SHELBYTEAM/SHELBY/master/SHELBY.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس شيلبي\n ❃∫ الاصدار » { 6.7v}')
dofile('SHELBY.lua')  
end
if text == 'تحديث المتجر ❃' and DevSHELBYW(msg) then 
  io.popen("mkdir File_Bot")
  io.popen("cd File_Bot && rm -rf ga.lua.1") 
  io.popen("cd File_Bot && rm -rf ga.lua.2") 
  io.popen("cd File_Bot && rm -rf ga.lua.3") 
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SHELBYTEAM/Files_SHELBY/master/File_Bot/ga.lua")  
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SHELBYTEAM/Files_SHELBY/master/File_Bot/rd.lua") 
  send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث \n ❃∫ لديك اخر اصدار للمتجر')
  dofile('SHELBY.lua')  
  end
if text == 'رقم البناء ❃' and DevSHELBYW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اهلاء عزيزي \n رقم البناء خاص بوتك {lua~{m7a29}')
end
if text == 'الاصدار ❃' and DevSHELBYW(msg) then 
  database:del(bot_id..'Srt:Bot') 
  send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس شيلبي \n ❃∫ الاصدار »{ 6.7v}')
  end
  if text == 'مطور السورس ❃' and DevSHELBYW(msg) then 
    database:del(bot_id..'Srt:Bot') 
    send(msg.chat_id_, msg.id_,' ❃∫ تنويه : قبل لا تراسل المطور تاكد انو عندك شغله مهمه \n\n المطور - @JJEJJ ')
    end
if text == 'قناه تحديثات البوت ❃' and DevSHELBYW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/SSS_Hl) \n ❃∫ [قناه السورس](t.me/SSS_Hl)')
end
if text == "ضع اسم للبوت ❃" and DevSHELBYW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevSHELBYW(msg) then 
...
if text == 'المشتركين ❃' and DevSHELBYW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevSHELBYW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevSHELBYW(msg) then
...
if text == ("قائمه العام ❃") and DevSHELBYW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevSHELBYW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevSHELBYW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevSHELBYW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevSHELBYW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevSHELBYW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevSHELBYW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevSHELBYW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevSHELBYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevSHELBYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..SHELBYk..''..SHELBY..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevSHELBYW(msg) then
...
send(msg.chat_id_,msg.id_," ❃∫ عذرا عزيزي المستخدم هاذا يوزر قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'SSS_Hl')..')'
status  = '\n ❃∫ تم ترقيته مطور'
texts = usertext..status
else
texts = ' ❃∫ لا يوجد حساب بهاذا اليوزر'
end
...
if text and text:match("^رفع مطور (%d+)$") and DevSHELBYW(msg) then
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SSS_Hl')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevSHELBYW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevSHELBYW(msg) then
...
local SHELBY1_Msg = database:get(bot_id.."SHELBY1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SHELBY1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SSS_Hl')..') \n ❃∫ '..SHELBY1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_, ' ❃∫ اليوزر لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' ❃∫ عذا لا يمكنك وضع يوزر حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' ❃∫ عذا لا يمكنك وضع يوزر كروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' ❃∫ البوت ادمن في القناة \n ❃∫ تم تفعيل الاشتراك الاجباري في \n ❃∫ ايدي القناة ('..data.id_..')\n ❃∫ يوزر القناة ([@'..data.type_.channel_.username_..'])')
...
--------------------------------------------------------------------------------------------------------------
if SHELBY_Msg and not Special(msg) then  
local SHELBY_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SHELBY_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..SHELBY_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/SSS_Hl)}\n ❃∫ ["..SHELBY_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/SSS_Hl)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSHELBYW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevSHELBYW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevSHELBYW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي يوزر القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSHELBYW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevSHELBYW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevSHELBYW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي يوزر القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevSHELBYW(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_," ❃∫ الاشتراك الاجباري مفعل \n ❃∫ على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," ❃∫ اهلا عزيزي المطور \n ❃∫ ارسل الان يوزر قناتك")
end
return false  
end
if text == "تعطيل الاشتراك الاجباري ❃" and DevSHELBYW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevSHELBYW(msg) then  
...
database:sadd(bot_id.."SHELBY:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SHELBY:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_SHELBY = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_SHELBY then 
names_SHELBY = database:smembers(bot_id.."SHELBY:blocname"..msg.chat_id_) or ""
if names_SHELBY and names_SHELBY[1] then 
for i=1,#names_SHELBY do 
if name_SHELBY:match("(.*)("..names_SHELBY[i]..")(.*)") then 
...
database:set(bot_id.."SHELBY:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SHELBY:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SHELBY:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SHELBY:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SHELBY:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_SHELBYa_new(SHELBY1,SHELBY2)
if SHELBY2 and SHELBY2.first_name_ then 
if SHELBY2.first_name_:match("(.*)"..database:get(bot_id.."SHELBY:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SHELBY:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local SHELBY_nnn = database:get(bot_id.."SHELBY:nump"..msg.chat_id_) or 5
local SHELBY_nnn2 = database:get(bot_id.."SHELBY:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(SHELBY_nnn2) == tonumber(SHELBY_nnn) or tonumber(SHELBY_nnn2) > tonumber(SHELBY_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SHELBY:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..SHELBY2.username_.."](https://t.me/"..(SHELBY2.username_ or "SSS_Hl")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SHELBY:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(SHELBY_nnn) - tonumber(SHELBY_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_SHELBYa_new)
end
end
...
local SHELBYChengName = database:get(bot_id.."SHELBY:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SHELBYChengName then 
send(msg.chat_id_, msg.id_, " خوش يوزر جان ["..SHELBYChengName..']')
database:del(bot_id.."SHELBY:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SHELBYChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."SHELBY:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
end
if text == "تفعيل تنبيه اليوزر" and Constructor(msg) and database:get(bot_id.."AL:Sre:stats") == "✔" then
send(msg.chat_id_, msg.id_, '❃∫ تم تفعيل تنبيه اليوزر')
database:set(bot_id.."Ttn:Userr:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه اليوزر" and Constructor(msg) and database:get(bot_id.."AL:Sre:stats") == "✔" then
send(msg.chat_id_, msg.id_, '❃∫ تم تعطيل تنبيه اليوزر')
...
if data.id_ then 
if data.id_ ~= bot_id then
local SHELBYChengUserName = database:get(bot_id.."SHELBY:Cheng:UserName"..data.id_)
if not data.username_ then 
if SHELBYChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف يوزره خمطو بساع بساع  \n هاذه يوزره  : [@"..SHELBYChengUserName..']')
database:del(bot_id.."SHELBY:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SHELBYChengUserName ~= data.username_ then 
local Text = {
'شكو غيرت يوزرك شنو نشروك بقنوات فضايح😂🥺',
"هاها شو غيرت يوزرك بس لا هددتك/ج الحب",
"شسالفه شو غيرت يوزرك 😐🌝",
"غير يوزره خمطو بساع بساع \n هاذه يوزره : @"..data.username_.."",
'ها عار مو جان يوزرك \n شكو غيرته ل @'..data.username_..' ',
'ها يول شو مغير يوزرك بيش مشتري يول', 
"منور يوزر جديد :  "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."SHELBY:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SHELBYChengPhoto = database:get(bot_id.."SHELBY:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SHELBYChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."SHELBY:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SHELBYChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."SHELBY:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevSHELBYW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SSS_Hl')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
if text == 'قفل اليوزرات' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:user:name"..msg.chat_id_,'del')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SSS_Hl')..') \n ❃∫ تـم قفـل اليوزرات ')
end,nil)   
elseif text == 'قفل اليوزرات بالتقييد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:user:name"..msg.chat_id_,'ked')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SSS_Hl')..') \n ❃∫ تـم قفـل اليوزرات بالتقييد ')
end,nil)   
elseif text == 'قفل اليوزرات بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:user:name"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SSS_Hl')..') \n ❃∫ تـم قفـل اليوزرات بالكتم ')
end,nil)   
elseif text == 'قفل اليوزرات بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:user:name"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SSS_Hl')..') \n ❃∫ تـم قفـل اليوزرات بالطرد ')
end,nil)   
elseif text == 'فتح اليوزرات' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SSS_Hl')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevSHELBYW(msg) then    
dofile('SHELBY.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSHELBYW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevSHELBYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevSHELBYW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevSHELBYW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevSHELBYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevSHELBYW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevSHELBYW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevSHELBYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevSHELBYW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevSHELBYW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevSHELBYW(msg) then
...
if text == 'الملفات' and DevSHELBYW(msg) then
t = ' ❃∫ ملفات السورس شيلبي ↓\n≪━━━━━━ 𝑺𝑯━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevSHELBYW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SHELBYTEAM/Files_SHELBY/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات شيلبي\n ❃∫ ملفات السورس ↓\n≪━━━━━━ 𝑺𝑯━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━ 𝑺𝑯━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس شيلبي ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/SSS_Hl) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevSHELBYW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SHELBYTEAM/Files_SHELBY/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SHELBY.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس شيلبي \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevSHELBYW(msg) then
...
if text == "مسح الملفات" and DevSHELBYW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevSHELBYW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevSHELBYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "SSS_Hl")
...
function Function_SHELBY(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_SHELBY, nil)
return false 
end
...
send(msg.chat_id_, msg.id_,"❃∫ لا يوجد حساب بهاذا اليوزر")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_SHELBY, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SSS_Hl')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SSS_Hl')..')'
...
database:set(bot_id.."SHELBY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SHELBY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SHELBY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SHELBY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SHELBY1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SHELBY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SHELBY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SHELBY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SHELBY1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SHELBY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."SHELBY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SHELBY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SHELBY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SHELBY1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SHELBY1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SHELBY1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SHELBY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SHELBY1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SHELBY1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━ 𝑺𝑯━━━━━━≫\n"
for k,v in pairs(list) do  
local SHELBY_Msg = database:get(bot_id.."SHELBY1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..SHELBY_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevSHELBYW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevSHELBYW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SSS_Hl')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevSHELBYW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevSHELBYW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'شيلبي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'شيلبي')
local SHELBY_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..SHELBY_Msg[math.random(#SHELBY_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSHELBYW(msg) then 
...
if text == ("مسح ردود المطور") and DevSHELBYW(msg) then 
...
if text == ("ردود المطور") and DevSHELBYW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━ 𝑺𝑯━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevSHELBYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevSHELBYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'شيلبي').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevSHELBYW(msg) then   
...
if text == 'تعطيل المغادره' and DevSHELBYW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SHELBY')..') '
...
send(msg.chat_id_, msg.id_,' ❃∫ اليوزر غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SSS_Hl')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_,' ❃∫ اليوزر غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' ❃∫ لا استطيع اصيح يوزر قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' ❃∫ لا استطيع اصيح يوزر بوتات') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'⚠| لا اسطيع صيح يوزرات الكروبات') 
return false  
end
if result.id_ then
...
-- vardump(data) 
SHELBYdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevSHELBYW(msg) then
...
zh = https.request('https://rudi-dev.tk/Amir1/SHELBY.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━ 𝑺𝑯━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━ 𝑺𝑯━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[( 𝑺𝑯𝑬𝑳𝑩𝒀) 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/SSS_Hl)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/SHELBY.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/SHELBY.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
SendText(msg.chat_id_,msg.id_,"- اليوزر غير صحيح \n*")   
return false  end   
...
if data.ID == "UpdateNewCallbackQuery" then
  ...
  local notText = 'مع ـلش آلآوآمر دي متخ ـصكش '
  ...
  local Teext =[[
    ...
    ⌯︙ الغاء كتم + حظر + تقيد ~ بالرد و يوزر و ايدي
    ⌯︙ تقيد ~ كتم + الرقم + ساعه
    ⌯︙ تقيد ~ كتم + الرقم + يوم
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'شيلبي')
...
SHELBY = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SHELBY)
...
--------------------------------------------------------------------------------------------------------------
SourceSHELBY(data.message_,data)
...
------------------------------------------------------------------------
local SHELBYAbot = database:get(bot_id.."SHELBY1:Add:Filter:Rp2"..text..result.chat_id_)   
if SHELBYAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..SHELBYAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SHELBY1_Msg = database:get(bot_id.."SHELBY1:Add:Filter:Rp2"..text..result.chat_id_)   
if SHELBY1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..SHELBY1_Msg)
